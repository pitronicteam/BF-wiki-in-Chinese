...
由于现在不再需要使用动态陷波滤波器来控制电机噪声，因此需要重新配置动态陷波滤波器。在配置程序的“滤波”页面内，将动态陷波滤波范围设置为“中”，将“动态陷波滤波器宽度百分比”设置为0，将“动态陷波滤波器Q”设置为250。![](../.gitbook/assets/rpmfilter-dynamic_filter_4.1_settings.png) 
